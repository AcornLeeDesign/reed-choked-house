...
// The dark backdrop paints from t=0 (so the 4s post-sleep "buffer" reads as
// pure darkness instead of lingering on the bed scene), and the smoke +
// soot grain reveal themselves only after this delay. Matches the 4000ms
...
const SMOKE_REVEAL_DELAY_MS = 4000
    ...
    <div className="burning-scene">
      ...
      <div className={smokeCls}>
        <AsciiScene
          ...
          density={1.575}
          parallaxPx={6}
          // 2× the default 0.004 swap rate per the burning-scene brief —
          // visibly more agitated character churn than the calm room scenes.
          swapRate={0.008}
          tickMs={120}
          palette={FIRE}
        />
